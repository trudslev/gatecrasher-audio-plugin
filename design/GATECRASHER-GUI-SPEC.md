...
**User-name cap: 25 characters.** 27 characters (252px cell less 10px padding each side = 232px, at 8.32px per character) less 2 for the dirty marker.
