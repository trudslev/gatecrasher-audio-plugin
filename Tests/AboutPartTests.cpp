...
public:
    ...
    void runTest() override
    {
        ...
        auto* editor = dynamic_cast<GatecrasherAudioProcessorEditor*> (processor.createEditor());
        ...
        /*  **This casting's wordmark is a BITMAP**, which is the objection revision 2 used to rule
            ...
            with drawn letterforms, because this is the case the argument was about. */
        ...
        expect (nf::AboutBox::repositoryFits ("github.com/trudslev/gatecrasher-audio-plugin"),
        ...
        expect (nf::testing::writeComponentPng (*content, dir.getChildFile ("gatecrasher-rest.png")),
        ...
        expect (nf::testing::writeComponentPng (*content, dir.getChildFile ("gatecrasher-about.png")),
